...
## Correlations for Block 1 Outcomes vs NARA

```{r p_corr_ct b1}
p_corr_ct_b1 <- ggplot(b1, aes(x=Total_Time, y=NARA)) + 
  geom_point()+
...
```{r echo=TRUE}
corr_ct_b1 <- cor.test(b1$Total_Time, b1$NARA)
corr_ct_b1
```


```{r p_corr_ctnav b1}
p_corr_ctnav_b1 <- ggplot(b1, aes(x=Navigation_Time, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Navigation Time")+
  ylim(0,100)
p_corr_ctnav_b1
```

```{r echo=TRUE}
corr_ctnav_b1 <- cor.test(b1$Navigation_Time, b1$NARA)
corr_ctnav_b1
```

```{r p_corr_ctori b1}
p_corr_ctori_b1 <- ggplot(b1, aes(x=Orientation_Time, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Orientation Time")+
  ylim(0,100)
p_corr_ctori_b1
```

```{r echo=TRUE}
corr_ctori_b1 <- cor.test(b1$Orientation_Time, b1$NARA)
corr_ctori_b1
```

```{r p_corr_dt b1}
p_corr_dt_b1 <- ggplot(b1, aes(x=Distance, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Distance")+
  ylim(0,100)
...
```{r echo=TRUE}
corr_dt_b1 <- cor.test(b1$Distance, b1$NARA)
corr_dt_b1
```

```{r p_corr_speed b1}
p_corr_speed_b1 <- ggplot(b1, aes(x=Speed, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Speed")+
  ylim(0,100)
...
```{r echo=TRUE}
corr_speed_b1 <- cor.test(b1$Speed, b1$NARA)
corr_speed_b1
```

```{r p_corr_dwell b1}
p_corr_dwell_b1 <- ggplot(b1, aes(x=Mean_Dwell, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Mean Dwell Time")+
  ylim(0,100)
p_corr_dwell_b1
```

```{r echo=TRUE}
corr_dwell_b1 <- cor.test(b1$Mean_Dwell, b1$NARA)
corr_dwell_b1
```

```{r p_corr_varx b1}
p_corr_varx_b1 <- ggplot(b1, aes(x=Var_X, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Var X")+
  ylim(0,100)
...
```{r echo=TRUE}
corr_varx_b1 <- cor.test(b1$Var_X, b1$NARA)
corr_varx_b1
```


```{r p_corr_vary b1}
p_corr_vary_b1 <- ggplot(b1, aes(x=Var_Y, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Var Y")+
  ylim(0,100)
...
```{r echo=TRUE}
corr_vary_b1 <- cor.test(b1$Var_Y, b1$NARA)
corr_vary_b1
```


```{r p_corr_varz b1}
p_corr_varz_b1 <- ggplot(b1, aes(x=Var_Z, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Var Z")+
  ylim(0,100)
...
```{r echo=TRUE}
corr_varz_b1 <- cor.test(b1$Var_Z, b1$NARA)
corr_varz_b1
```


```{r p_corr_teleport b1}
p_corr_teleport_b1 <- ggplot(b1, aes(x=Teleportations, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("B1 Teleportations")+
  ylim(0,100)
p_corr_teleport_b1
```

```{r echo=TRUE}
corr_teleport_b1 <- cor.test(b1$Teleportations, b1$NARA)
corr_teleport_b1
```
