...
```{r p_corr_ct}
p_corr_ct <- ggplot(all_blocks, aes(x=Total_Time, y=NARA)) + 
  geom_point()+
...
```{r p_corr_ctnav}
p_corr_ctnav <- ggplot(all_blocks, aes(x=Navigation_Time, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
...
```{r p_corr_ctori}
p_corr_ctori <- ggplot(all_blocks, aes(x=Orientation_Time, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
...
```{r p_corr_dt}
p_corr_dt <- ggplot(all_blocks, aes(x=Distance, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("Distance")+
  ylim(0,100)
...
```{r p_corr_speed}
p_corr_speed <- ggplot(all_blocks, aes(x=Speed, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("Speed")+
  ylim(0,100)
...
```{r p_corr_varx}
p_corr_varx <- ggplot(all_blocks, aes(x=Var_X, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("Var X")+
  ylim(0,100)
...
```{r p_corr_vary}
p_corr_vary <- ggplot(all_blocks, aes(x=Var_Y, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("Var Y")+
  ylim(0,100)
...
```{r p_corr_varz}
p_corr_varz <- ggplot(all_blocks, aes(x=Var_Z, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("Var Z")+
  ylim(0,100)
...
```{r p_corr_teleport}
p_corr_teleport <- ggplot(all_blocks, aes(x=Teleportations, y=NARA)) + 
  geom_point()+
  geom_smooth(method=lm)+
  xlab("Teleportations")+
  ylim(0,100)
