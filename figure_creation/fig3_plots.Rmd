...
p_ct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_ct.svg", plot=p_ct)
```
...
p_orict <- ggplot(data, aes(x=Block_num, y=Orientation_Time, color=Participant))+
  ...
  theme(axis.title.y = element_text(size=16))
p_orict
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_orict.svg", plot=p_orict)
```
...
p_navct <- ggplot(data, aes(x=Block_num, y=Navigation_Time, color=Participant))+
  ...
  theme(axis.title.y = element_text(size=16))
p_navct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_navct.svg", plot=p_navct)
```
...
p_dt <- ggplot(data, aes(x=Block_num, y=Distance, color=Participant))+
  ...
  theme(axis.title.y = element_text(size=16))
p_dt
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_dt.svg", plot=p_dt)
```
...
p_speed <- ggplot(data, aes(x=Block_num, y=Speed, color=Participant))+
  ...
  theme(axis.title.y = element_text(size=16))
p_speed
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_speed.svg", plot=p_speed)
```
...
p_dwell <- ggplot(data, aes(x=Block_num, y=Mean_Dwell, color=Participant))+
  ...
  theme(axis.title.y = element_text(size=16))
p_dwell
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_dwell.svg", plot=p_dwell)
``` 
...
p_teleport <- ggplot(data, aes(x=Block_num, y=Teleportations, color=Participant))+
  ...
  theme(axis.title.y = element_text(size=16))
p_teleport
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_teleport.svg", plot=p_teleport)
```
...
p_varx <- ggplot(data, aes(x=Block_num, y=Var_X, color=Participant))+
  geom_line(data, mapping = aes(x= Block_num, y = Var_X, group = Participant, color = Participant), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  ...
  geom_point(data.summary, mapping = aes(x= Block_num, y = Var_X, group = 1), size = 1.5, color = '#242526')+
  stat_summary(fun.args = list(mean_se), 
                geom="errorbar", 
                width=0.2, 
                color="#242526") +
  ...
  theme(axis.title.y = element_text(size=16))
p_varx
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_varx.svg", plot=p_varx)
```
...
p_vary <- ggplot(data, aes(x=Block_num, y=Var_Y, color=Participant))+
  geom_line(data, mapping = aes(x= Block_num, y = Var_Y, group = Participant, color = Participant), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  ...
  geom_point(data.summary, mapping = aes(x= Block_num, y = Var_Y, group = 1), size = 1.5, color = '#242526')+
  stat_summary(fun.args = list(mean_se), 
                geom="errorbar", 
                width=0.2, 
                color="#242526") +
  ...
  theme(axis.title.y = element_text(size=16))
p_vary
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_vary.svg", plot=p_vary)
```
...
p_varz <- ggplot(data, aes(x=Block_num, y=Var_Z, color=Participant))+
  geom_line(data, mapping = aes(x= Block_num, y = Var_Z, group = Participant, color = Participant), alpha = .3)+
  scale_color_viridis(option = "plasma", discrete = TRUE)+
  ...
  geom_point(data.summary, mapping = aes(x= Block_num, y = Var_Z, group = 1), size = 1.5, color = '#242526')+
  stat_summary(fun.args = list(mean_se), 
                geom="errorbar", 
                width=0.2, 
                color="#242526") +
  ...
  theme(axis.title.y = element_text(size=16))
p_varz
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig3_varz.svg", plot=p_varz)
```
