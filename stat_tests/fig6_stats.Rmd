...
```{r echo=TRUE}
corr_b1_ct <- cor.test(b1$Total_Time, b1$NARA)
corr_b1_ct
```
...
```
```{r echo=TRUE}
corr_b1_ctnav <- cor.test(b1$Navigation_Time, b1$NARA)
corr_b1_ctnav
```
...
```{r echo=TRUE}
corr_b1_ctori <- cor.test(b1$Orientation_Time, b1$NARA)
corr_b1_ctori
```
...
```{r echo=TRUE}
corr_b1_dt <- cor.test(b1$Distance, b1$NARA)
corr_b1_dt
```
...
```{r echo=TRUE}
corr_b1_dwell <- cor.test(b1$Mean_Dwell, b1$NARA)
corr_b1_dwell
```
...
```{r echo=TRUE}
corr_b1_speed <- cor.test(b1$Speed, b1$NARA)
corr_b1_speed
```
...
```{r echo=TRUE}
corr_b1_teleport <- cor.test(b1$Teleportations, b1$NARA)
corr_b1_teleport
```
...
```{r echo=TRUE}
corr_change_ct <- cor.test(change$Total_Time, change$NARA)
corr_change_ct
```
...
```{r echo=TRUE}
corr_change_ctori <- cor.test(change$Orientation_Time, change$NARA)
corr_change_ctori
```
```{r p_corr_ctnav}
...
```{r echo=TRUE}
corr_change_ctnav <- cor.test(change$Navigation_Time, change$NARA)
corr_change_ctnav
```
...
```{r echo=TRUE}
corr_change_dt <- cor.test(change$Distance, change$NARA)
corr_change_dt
```
...
```{r echo=TRUE}
corr_change_dwell <- cor.test(change$Mean_Dwell, change$NARA)
corr_change_dwell
```
...
```{r echo=TRUE}
corr_change_speed <- cor.test(change$Speed, change$NARA)
corr_change_speed
```
...
```{r echo=TRUE}
corr_change_teleport <- cor.test(change$Teleportations, change$NARA)
